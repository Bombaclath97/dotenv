...
class AsciidocPreview {
    constructor(webview, resource, locked, _contentProvider, _previewConfigurations, _logger, topmostLineMonitor, _contributions) {
        ...
        vscode.window.onDidChangeActiveTextEditor((editor) => {
            if (editor && file_1.isAsciidocFile(editor.document) && !this._locked) {
    ...
    doUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const content = yield this._contentProvider.providePreviewHTML(document, this._previewConfigurations, this.line, this.state);
    ...
    static getLocalResourceRoots(resource, contributions) {
        let baseRoots = [vscode.Uri.file(path.join(contributions.extensionPath, 'media')),
    ...
    onDidClickPreviewLink(path, fragment) {
        return __awaiter(this, void 0, void 0, function* () {
            const openLinks = this.config.get('preview.openAsciidocLinks', 'inPreview');
            if (openLinks === 'inPreview') {
                const asciidocLink = yield openDocumentLink_1.resolveLinkToAsciidocFile(path);
                if (asciidocLink) {
